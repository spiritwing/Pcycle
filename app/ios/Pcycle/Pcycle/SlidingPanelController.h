...
typedef enum _SlidingPanelStyle {
    SlidingPanelSingleActive = 0,
    SlidingPanelMultipleActive
} SlidingPanelStyle;

typedef enum _SlidingPanelState {
    SlidingPanelCenterVisible = 1,
    SlidingPanelLeftVisible,
    SlidingPanelRightVisible
} SlidingPanelState;

@interface SlidingPanelController : UIViewController<UIGestureRecognizerDelegate>
...
// style
@property (nonatomic) SlidingPanelStyle style; // default is SlidingPanelSingleActive
...
@property (nonatomic, readonly) SlidingPanelState state;
